// STEP 1 - Chanaged identifier names to Camel case notation
// let someMonth;
// function theMonth();
// let currentMonth;
// let summerMonth;
...
// STEP 2 - Example of numeric literal expression, a string literal expression, a Boolean literal expression, and a null literal expression
// 4.5                                             //numeric literal expression
// "Hola! How are you?"                            //string literal expression
// true                                            //Boolean literal expression
// null                                            //null literal expression

// STEP 3- Examples of Complex and variable expressions
...
// let iZipCode = 92154, strLastName = "Pereda";
...
// let x = Number(prompt("Enter a number between 0 and 5: "));
// let y = Number(prompt("Enter a number between 6 and 10: "));
// let z = (x !== 0) && (y+x === 10);
// if (z === true) {
